...
public class filterROC {
	...
	private static double classifySpam = 0;
	private static double classifyHam = 0;
	...
	public static void main (String[] args) {
		...
		if(classify(testFile, pSpam, pHam)){
			System.out.println("0 "+ (classifyHam)/100 + "\n");
		}

		else{
			System.out.println("1 "+ (classifyHam)/100 +"\n");
		}
	}
